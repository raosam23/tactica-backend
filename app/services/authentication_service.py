...
from app.schemas.auth import DeleteAccountResponse, RegisterResponse
from app.utils.security import (create_access_token, hash_password,
                                verify_password)


async def RegisterService(session: AsyncSession, email: str, password: str, name: Optional[str] = None) -> Optional[RegisterResponse]:
